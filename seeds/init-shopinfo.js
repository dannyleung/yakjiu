  ...
  return knex('shopinfo').del()
    .then(function () {
      ...
      return knex('shopinfo').insert([
        ...
        description:'Google Pay is used to make quick and easy purchases within merchants by leveraging existing payment credentials from Google.<br><br>Shoppers will be conducting TEST PURCHASES on their smartphone or desktop/laptop and opting to pay using Google Pay for the merchant they are testing. <br><br>Understanding how to use Google Pay is required. If you are not sure how to use the Google Pay, please Google instructions. <br><br>A purchase may be required for your assignment. Check your specific shop for details and review the In-App Merchant Payment Scenario file. <br><br>Each shopper can only shop each merchant once within a 30 day period.'},
        ...
        question4: "Upload a photo of the view from your seat" , shopname: "Hotel Lobby Research", credit: 30, quota: 8, description:'Survey for Hotel Lobby areas <br><br>When entering the Hotel go to any venue/seating area and make note of the service provided.<br><br>Order food & a drink. Take note of the staff and level of service provided.',taken:[1,5], status:"Live"},
