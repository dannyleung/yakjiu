  ...
  return knex('shopinfo').del()
    .then(function () {
      ...
      return knex('shopinfo').insert([
        ...
        question4: "Upload your shop image" , shopname: "Godiva Hong Kong-Convention Plaza", credit: 50, quota: 10, taken:[84,34]},
        ...
        question1: "What the shop look like?" , question2: "Do you like the shop?" , question3: "Do you agree that the staff is nice?",
        question4: "Upload your shop image" , shopname: "Godiva Hong Kong-14 D'Aguilar Street", credit: 50, quota: 10},
