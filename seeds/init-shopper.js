  ...
  return knex('shopperinfo').del()
    .then(function () {
      ...
      return knex('shopperinfo').insert([
        {id: 1, username: 'admin', password: '$2b$10$TgII7yQGvYpQ8fHlU0m44.LAX6aE5.IyF9MCyAb3eNn1d1ENrLApO', email: 'pk@pk.com', firstname: 'YinChung', lastname: 'Lau', gender: 'M', age: 17},
